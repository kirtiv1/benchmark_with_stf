...
@snowflake
@pytest.mark.parametrize('number_of_threads_and_tables', [1])
#@pytest.mark.parametrize('number_of_threads_and_tables', [1, 2, 4, 8])
@pytest.mark.parametrize('batch_size', [2000])
...
def test_multithreaded_batch_sizes(sdc_builder, sdc_executor, snowflake, number_of_threads_and_tables, batch_size, stage_location):
    ...
    try:
        ...
        sdc_executor.benchmark_pipeline(pipeline, record_count=2_000_0)
    finally:
